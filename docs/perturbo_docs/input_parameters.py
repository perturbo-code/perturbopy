...
def main():
   ...
   input_param_path = '../../src/perturbopy/generate_input/input_parameters_perturbo.yml'
   ...
   f90tools.autogen_declare_init_bcast_inputvariables('./', input_param_path, 'perturbo')

   # For qe2pert.x
   print('param_to_yaml_qe2pert.f90')
   input_param_path = '../../src/perturbopy/generate_input/input_parameters_qe2pert.yml'
   ...
   f90tools.autogen_declare_init_bcast_inputvariables('./', input_param_path, 'qe2pert')
   #
